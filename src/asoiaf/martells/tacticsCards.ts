...
const cardData: CardData = {
  ...
  'A Need For Vengeance - Daemon Sand': {
    ...
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-daemon-sand-vk-t1.png',
    imageUrlBack: '',
  },
  'Coordinated Plotting - Daemon Sand': {
    name: 'Coordinated Plotting - Daemon Sand',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-daemon-sand-vk-t2.png',
    imageUrlBack: '',
  },
  'Pathetic Attempt - Daemon Sand': {
    name: 'Pathetic Attempt - Daemon Sand',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-daemon-sand-vk-t3.png',
    imageUrlBack: '',
  },
  'Lone Knight - Gerold Dayne': {
    name: 'Lone Knight - Gerold Dayne',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-gerold-dayne-d-t1.png',
    imageUrlBack: '',
  },
  'Coup Attempt - Gerold Dayne': {
    name: 'Coup Attempt - Gerold Dayne',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-gerold-dayne-d-t2.png',
    imageUrlBack: '',
  },
  'Reckless Strikes - Gerold Dayne': {
    name: 'Reckless Strikes - Gerold Dayne',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-gerold-dayne-d-t3.png',
    imageUrlBack: '',
  },
  ...
  'Ripe To Act - Doran Martell': {
    ...
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-areo-hotah-cotg-t1.png',
    imageUrlBack: '',
  },
  'Parlay - Doran Martell': {
    name: 'Parlay - Doran Martell',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-areo-hotah-cotg-t2.png',
    imageUrlBack: '',
  },
  ...
  'Set For Charge - Harmen Uller': {
    ...
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-harmen-uller-loh-t1.png',
    imageUrlBack: '',
  },
  'Battle Endurance - Harmen Uller': {
    name: 'Battle Endurance - Harmen Uller',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-harmen-uller-loh-t2.png',
    imageUrlBack: '',
  },
  'Spiteful Truce - Harmen Uller': {
    name: 'Spiteful Truce - Harmen Uller',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://asoiaf-tmg-discord-bot.s3.amazonaws.com/images/hm-harmen-uller-loh-t3.png',
    imageUrlBack: '',
  },
};
