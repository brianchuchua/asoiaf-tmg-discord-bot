...
const cardData: CardData = {
  'Tactical Approach - Neutral': {
    ...
    imageUrl: 'https://onthetablegaming.com/asoiaf-builder-images/asoiafbuilder2021/n-t1.png',
    imageUrlBack: '',
  },
  'Adaptive Methods - Neutral': {
    name: 'Adaptive Methods - Neutral',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://onthetablegaming.com/asoiaf-builder-images/asoiafbuilder2021/n-t2.png',
    imageUrlBack: '',
  },
  ...
  'Sellsword Negotiations - Daario Naharis (Neutral)': {
    ...
    type: CardTypes.TacticsCard,
    imageUrl: 'https://onthetablegaming.com/asoiaf-builder-images/asoiafbuilder2021/n-daario-naharis-sc-t1.png',
    imageUrlBack: '',
  },
  'Sellsword Bravado - Daario Naharis (Neutral)': {
    name: 'Sellsword Bravado - Daario Naharis (Neutral)',
    type: CardTypes.TacticsCard,
    imageUrl: 'https://onthetablegaming.com/asoiaf-builder-images/asoiafbuilder2021/n-daario-naharis-sc-t2.png',
    imageUrlBack: '',
  },
